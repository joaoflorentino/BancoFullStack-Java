...
public class Aluno {
	...
	public Aluno(String matricula, String nome) {//Construtor com apenas nomes e codigo
	...
	public Aluno(String matricula, String nome, float nota01, float nota02, float notaTrabalho) {
	...
	public String toString() {
		return "Aluno Curso Basico II [matricula=" + matricula + ", nome=" + nome + ", nota01=" + nota01 + ", nota02="
